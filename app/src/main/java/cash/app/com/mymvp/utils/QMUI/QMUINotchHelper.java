...
package cash.app.com.mymvp.utils.QMUI;
...
import cash.app.com.mymvp.utils.DebugLog;
...
public class QMUINotchHelper {
    ...
    public static boolean hasNotchInVivo(Context context) {
        ...
        try {
            ...
            DebugLog.i(TAG, "hasNotchInVivo ClassNotFoundException");
        } catch (Exception e) {
            DebugLog.e(TAG, "hasNotchInVivo Exception");
        }
        return ret;
    }
    ...
    public static boolean hasNotchInHuawei(Context context) {
        ...
        try {
            ...
            DebugLog.i(TAG, "hasNotchInHuawei ClassNotFoundException");
        } catch (NoSuchMethodException e) {
            DebugLog.e(TAG, "hasNotchInHuawei NoSuchMethodException");
        } catch (Exception e) {
            DebugLog.e(TAG, "hasNotchInHuawei Exception");
        }
        return hasNotch;
    }
    ...
    public static int[] getNotchSizeInHuawei(Context context) {
        if (sNotchSizeInHawei == null) {
            ...
            try {
                ...
                DebugLog.e(TAG, "getNotchSizeInHuawei ClassNotFoundException");
            } catch (NoSuchMethodException e) {
                DebugLog.e(TAG, "getNotchSizeInHuawei NoSuchMethodException");
            } catch (Exception e) {
                DebugLog.e(TAG, "getNotchSizeInHuawei Exception");
            }
